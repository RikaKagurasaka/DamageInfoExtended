...
internal static class MitigationCalculator
{
    ...
    // Better Deaths. Every public rule has a verified numeric status ID so
    // localized clients do not depend on translated status names.
    private static readonly MitigationRule[] Rules =
    [
        new("Rampart", 20, MitigationScope.All, StatusId: 1191),
        new("Sentinel", 30, MitigationScope.All, StatusId: 74),
        ...
        new("Sheltron", 15, MitigationScope.All, StatusId: 728),
        new("Holy Sheltron", 15, MitigationScope.All, StatusId: 2674),
        new("Knight's Resolve", 15, MitigationScope.All, StatusId: 2675),
        new("Passage of Arms", 15, MitigationScope.All, StatusId: 1176),
        new("Raw Intuition", 10, MitigationScope.All, StatusId: 735),
        new("Bloodwhetting", 10, MitigationScope.All, StatusId: 2678),
        new("Nascent Glint", 10, MitigationScope.All, StatusId: 1858),
        new("Stem the Flow", 10, MitigationScope.All, StatusId: 2679),
        new("Vengeance", 30, MitigationScope.All, StatusId: 89),
        ...
        new("Shadow Wall", 30, MitigationScope.All, StatusId: 747),
        new("Shadowed Vigil", 40, MitigationScope.All, StatusId: 3835),
        new("Oblation", 10, MitigationScope.All, StatusId: 2682),
        new("Camouflage", 10, MitigationScope.All, StatusId: 1832),
        new("Nebula", 30, MitigationScope.All, StatusId: 1834),
        new("Great Nebula", 40, MitigationScope.All, StatusId: 3838),
        new("Heart of Stone", 15, MitigationScope.All, StatusId: 1840),
        new("Heart of Corundum", 15, MitigationScope.All, StatusId: 2683),
        new("Clarity of Corundum", 15, MitigationScope.All, StatusId: 2684),
        ...
        new("Fey Illumination", 5, MitigationScope.Magical, StatusId: 317),
        new("Seraphic Illumination", 5, MitigationScope.Magical, StatusId: 1875),
        ...
        new("Sun Sign", 10, MitigationScope.All, StatusId: 3896),
        new("The Bole", 10, MitigationScope.All, StatusId: 830),
        new("Kerachole", 10, MitigationScope.All, StatusId: 2618),
        new("Taurochole", 10, MitigationScope.All, StatusId: 2619),
        new("Holos", 10, MitigationScope.All, StatusId: 3003),
        new("Riddle of Earth", 20, MitigationScope.All, StatusId: 1179),
        new("Third Eye", 10, MitigationScope.All, StatusId: 1232),
        ...
        new("Tactician", 15, MitigationScope.All, StatusId: 1197),
        new("Shield Samba", 15, MitigationScope.All, StatusId: 1826),
        new("Magick Barrier", 10, MitigationScope.Magical, StatusId: 2707),
